		   ...
		   <table>
              ...
              <form method="post" name="regForm" onsubmit="return validation()" action="ddd">
                 <tr>
                    ...
                    <td class="profile"><input type="text" value="<jsp:expression> name</jsp:expression>" name="uname" onkeyup="val('name_error')"/><br><span id="name_error" style="color: red"></span></td>
                 </tr>
                 <tr>
                     <td class="profile"><h4>User Email:</h4></td>
                      <td class="profile"><input type="email" value="<jsp:expression>umail</jsp:expression>" name="umail" onkeyup="val('email_error')"/><br><span id="email_error" style="color: red"></span></td>
                 </tr>
                  <tr>
                     <td class="profile"><h4>User Number:</h4></td>
                     <td class="profile"><input type="number"  value="<jsp:expression> unum</jsp:expression>" name="unum" onkeyup="val('num_error')"/><br><span id="num_error" style="color: red"></span></td>
                 </tr>
                 <tr>
                     <td class="profile"> <h4>Gardian Name:</h4></td>
                     <td class="profile"><input type=text value="<jsp:expression>g1name</jsp:expression>" name="g1name" onkeyup="val('name2_error')"/><br><span id="name2_error" style="color: red"></span> </td>
                 </tr>
                 <tr>
                     <td class="profile"> <h4>Gardian Relation:</h4></td>
                     <td class="profile"><input type="text" value="<jsp:expression>g1relation</jsp:expression>" name="g1relation" onkeyup="val('relation1_error')"/><br><span id="relation1_error" style="color: red"></span></td>
                 </tr>
                 <tr>
                     <td class="profile"> <h4>Gardian Number:</td>
                     <td  class="profile"><input type="number" value="<jsp:expression>g1phone</jsp:expression>" name="g1num" onkeyup="val('num2_error')"/><br><span id="num2_error" style="color: red"></span></td>
                 </tr>
